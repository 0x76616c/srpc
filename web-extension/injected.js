(function () {
  ...
  window.AudioContext = function (...args) {
    ...
    console.log('%c[SRPC] Hooked AudioContext:', 'color: green; font-weight: bold;', ctx);
    return ctx;
  };
  ...
  const getMetadata = () => {
    ...
    const currentTime =
      parseFloat(document.querySelector('[role="progressbar"]')?.getAttribute('aria-valuenow')) || 0;
